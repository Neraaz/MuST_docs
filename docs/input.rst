...
.. list-table::
   ...
   * - Single Site Solution Method (>= -1)
     - 2
     - -1: Untruncated potential in solver, surface integration; 0: Untruncated potential in solver, Untruncated potential in volume integration; 1: Untruncated potential in solver, Truncated potential in volume integration; 2: Truncated potential in solver
     - Note: Defines how site potential is used in the iterative coupled integral solver; truncated potential is enforced if irregular solutions are used; default = 0
